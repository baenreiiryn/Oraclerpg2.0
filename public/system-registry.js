...
const systems=[Object.freeze({
  ...
  campaign:{
    ...
    subclasses:{pt:'/compendium/srd/pt-BR/subclasses.json',en:'/compendium/srd/en/subclasses.json'},
...
window.OracleSystems=Object.freeze({
  ...
  subclassCatalogUrl:(id,locale='pt')=>localized(byId.get(id)?.campaign?.subclasses,locale),
